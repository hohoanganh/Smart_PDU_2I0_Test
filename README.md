...
| `i2c` | Scan bus I2C (PCA9554=0x20, RTC=0x51) |
| `flash` / `fwr` | Đọc ID / test ghi-đọc SPI flash |
| `rs485 <text>` / `rsl` | Gửi RS485 / loopback |
| `u3` | Loopback UART3 (nối tắt PB10-PB11) |
| `rtc` / `time hh:mm:ss` | Đọc / đặt giờ RTC |
| `sht` | Đọc SHT45 nếu có gắn (Grove I2C) |
| `baud rs485\|u3 <bps>` | Đổi baudrate lúc chạy |
